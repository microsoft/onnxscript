...
from onnxscript.onnx_types import (BFLOAT16, BOOL, COMPLEX64, COMPLEX128,
                                   ...
                                   FLOAT8E5M2, FLOAT8E5M2FNUZ, FLOAT16, INT4,
                                   INT8, INT16, INT32, INT64, STRING, UINT4,
...
class Opset21(Opset20):
    ...
    T_GroupNormalization = TypeVar(
        "T_GroupNormalization", BFLOAT16, DOUBLE, FLOAT, FLOAT16
    )
