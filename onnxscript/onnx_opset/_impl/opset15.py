...
class Opset15(Opset14):
    ...
    T1_BatchNormalization = TypeVar(
        "T1_BatchNormalization", BFLOAT16, DOUBLE, FLOAT, FLOAT16
    )

    T2_BatchNormalization = TypeVar(
        "T2_BatchNormalization", BFLOAT16, DOUBLE, FLOAT, FLOAT16
    )
    ...
    def Shape(
        self, data: T_Shape, *, end: _Optional[int] = None, start: int = 0
    ) -> T1_Shape:
