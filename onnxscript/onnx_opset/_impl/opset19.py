...
class Opset19(Opset18):
    ...
    def DequantizeLinear(
        self,
        x: Union[FLOAT8E4M3FN, FLOAT8E4M3FNUZ, FLOAT8E5M2, FLOAT8E5M2FNUZ, INT32, INT8, UINT8],
        x_scale: Union[BFLOAT16, FLOAT, FLOAT16],
        x_zero_point: Optional[
            Union[FLOAT8E4M3FN, FLOAT8E4M3FNUZ, FLOAT8E5M2, FLOAT8E5M2FNUZ, INT32, INT8, UINT8]
        ] = None,
        axis: int = 1,
    ) -> Union[BFLOAT16, FLOAT, FLOAT16]:
        ...
        op: Callable[..., Union[BFLOAT16, FLOAT, FLOAT16]] = Op(
            self, "DequantizeLinear", schema
        )
    ...
    def QuantizeLinear(
        self,
        x: Union[BFLOAT16, FLOAT, FLOAT16, INT32],
        y_scale: Union[BFLOAT16, FLOAT, FLOAT16, INT32],
        y_zero_point: Optional[
            Union[FLOAT8E4M3FN, FLOAT8E4M3FNUZ, FLOAT8E5M2, FLOAT8E5M2FNUZ, INT8, UINT8]
        ] = None,
        axis: int = 1,
        saturate: int = 1,
    ) -> Union[FLOAT8E4M3FN, FLOAT8E4M3FNUZ, FLOAT8E5M2, FLOAT8E5M2FNUZ, INT8, UINT8]:
