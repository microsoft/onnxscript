...
from onnxscript.onnx_types import (BFLOAT16, BOOL, COMPLEX64, COMPLEX128,
                                   ...
                                   FLOAT8E8M0, FLOAT16, INT4, INT8, INT16,
                                   INT32, INT64, STRING, UINT4, UINT8, UINT16,
                                   UINT32, UINT64)
...
class Opset24(Opset23):
    ...
    T2_DequantizeLinear = TypeVar(
        "T2_DequantizeLinear", BFLOAT16, FLOAT, FLOAT16, FLOAT8E8M0
    )
