...
def aten_convolution_backward(
    ...
    dw_t = op.Conv(input_t, dz_t, pads=pads)
...
#@torch_op("aten::pow_backward", trace_only=True)
def aten_pow_backward(grad_output, self: TReal, exponent: TTensor) -> TensorType:
...
@torch_op(("aten::sub.Tensor", "aten::sub.Scalar", "aten::subtract.Tensor", "_operator::sub"))
