...
from onnxscript.diagnostics.infra.sarif._artifact_content import (
    ArtifactContent,
)
from onnxscript.diagnostics.infra.sarif._artifact_location import (
    ArtifactLocation,
)
...
from onnxscript.diagnostics.infra.sarif._external_properties import (
    ExternalProperties,
)
...
from onnxscript.diagnostics.infra.sarif._logical_location import (
    LogicalLocation,
)
...
from onnxscript.diagnostics.infra.sarif._physical_location import (
    PhysicalLocation,
)
...
from onnxscript.diagnostics.infra.sarif._reporting_descriptor import (
    ReportingDescriptor,
)
...
from onnxscript.diagnostics.infra.sarif._result_provenance import (
    ResultProvenance,
)
...
from onnxscript.diagnostics.infra.sarif._special_locations import (
    SpecialLocations,
)
...
from onnxscript.diagnostics.infra.sarif._thread_flow_location import (
    ThreadFlowLocation,
)
...
from onnxscript.diagnostics.infra.sarif._translation_metadata import (
    TranslationMetadata,
)
