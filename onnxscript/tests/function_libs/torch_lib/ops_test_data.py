...
OPINFO_FUNCTION_TARGET_DTYPE: dict[str, tuple[Any, ...],] = {
    "all_dim": (
        torch.float32,
        torch.float16,
    ),
    ...
    "chunk": (torch.float32,),
    "clamp": (torch.float32,),
    "clamp_max": (torch.float32,),
    "clamp_min": (torch.float32,),
    "clone": (torch.float32,),
    "col2im": (torch.float32,),
    "constant_pad_nd": (torch.float32,),
    "contiguous": (torch.float32,),
    "convolution": (torch.float32,),
    # "copy": core_ops.aten_copy,  # copy is not in OPS_DB
    "cos": (torch.float32,),
    "cosh": (torch.float32,),
    "cross": (torch.float32,),
    "cumsum": (torch.float32,),
    # "detach": core_ops.aten_detach,  # detach is not in OP-TEST-DB
    "div": (torch.float32,),
    "dot": (torch.float32,),
    "empty": (torch.float32,),
    "empty_like": (torch.float32,),
    # "empty_strided": core_ops.aten_empty_strided,  # empty_strided is not in OPS_DB
    "eq": (torch.float32,),
    "equal": (torch.float32,),
    "exp": (torch.float32,),
    "exp2": (torch.float32,),
    "expand": (torch.float32,),
    "expand_as": (torch.float32,),
    "erf": (torch.float32,),
    "fill": (torch.float32,),
    "flip": (torch.float32,),
    "floor": (torch.float32,),
    "fmod": (torch.float32,),
    "full": (torch.float32,),
    "full_like": (torch.float32,),
    "gather": (torch.float32,),
    "ge": (torch.float32,),
    # "greater_equal": core_ops.aten_greater_equal,  # no test case in OPS_DB
    # "greater": core_ops.aten_greater,  # no test case in OPS_DB
    ...
    # "is_same_size": core_ops.aten_is_same_size,  # no test case in OPS_DB
    # "is_nonzero": core_ops.aten_is_nonzero,  # no test case in OPS_DB
    "index_put_bool": (torch.float32,),
    "index_put": (torch.float32,),
    "index_select": (torch.float32,),
    "isclose": (torch.float32,),
    "isfinite": (torch.float32,),
    "isinf": (torch.float32,),
    "isnan": (torch.float32,),
    "isneginf": (torch.float32,),
    "isposinf": (torch.float32,),
    ...
    "lt": (torch.float32,),
    "masked_fill": (torch.float32,),
    "matmul": (torch.float32,),
    "maximum": (torch.float32,),
    "max": (torch.float32,),
    "max_pool2d": (torch.float32,),
    "max_pool3d": (torch.float32,),
    "min_dim": (torch.float32,),
    "min_other": (torch.float32,),
    "min": (torch.float32,),
    "minimum": (torch.float32,),
    "mm": (torch.float32,),
    "mul": (torch.float32,),
    "narrow": (torch.float32,),
    "native_batch_norm": (torch.float32,),
    "native_group_norm": (torch.float32,),
    "native_layer_norm": (torch.float32,),
    # "native_dropout": core_ops.aten_native_dropout,  # native_dropout is not in OPS_DB
    "ne": (torch.float32,),
    "neg": (torch.float32,),
    "new_empty_dtype": (torch.float32,),
    "new_empty": (torch.float32,),
    "new_empty_strided_dtype": (torch.float32,),
    "new_empty_strided": (torch.float32,),
    "new_full_dtype": (torch.float32,),
    "new_full": (torch.float32,),
    "new_ones_dtype": (torch.float32,),
    "new_ones": (torch.float32,),
    "new_zeros_dtype": (torch.float32,),
    "new_zeros": (torch.float32,),
    "nn.functional.adaptive_avg_pool1d": (torch.float32,),
    "nn.functional.adaptive_avg_pool2d": (torch.float32,),
    "nn.functional.adaptive_avg_pool3d": (torch.float32,),
    ...
    # use cross_entropy as test case instead of cross_entropy_loss (not in OPS_DB)
    "nn.functional.cross_entropy": (torch.float32,),
    "nn.functional.dropout": (torch.float32,),
    "nn.functional.elu": (torch.float32,),
    "nn.functional.embedding": (torch.float32,),
    ...
    "nn.functional.max_pool2d_with_indices": (torch.float32,),
    "nn.functional.max_pool3d": (torch.float32,),
    "nn.functional.max_pool3d_with_indices": (torch.float32,),
    "nn.functional.nll_loss_weight": (torch.float32,),
    "nn.functional.nll_loss": (torch.float32,),
    "nn.functional.reflection_pad2d": (torch.float32,),
    "nn.functional.relu": (torch.float32,),
    "nn.functional.relu6": (torch.float32,),
    "nn.functional.replication_pad2d": (torch.float32,),
    "nn.functional.replication_pad3d": (torch.float32,),
    "nn.functional.scaled_dot_product_attention": (torch.float32,),
    "nn.functional.scaled_dot_product_attention_bool_mask": (torch.float32,),
    "nn.functional.selu": (torch.float32,),
    "nn.functional.mse_loss": (torch.float32,),
    "nn.functional.upsample_bilinear2d": (torch.float32,),
    "nn.functional.upsample_nearest2d": (torch.float32,),
    "nonzero": (torch.float32,),
    "normal": (torch.float32,),
    "ones": (torch.float32,),
    "ones_like": (torch.float32,),
    "permute": (torch.float32,),
    "pow": (torch.float32,),
    # "rand": core_ops.aten_rand,  # no test case in OPS_DB
    "randn": (torch.float32,),
    "reciprocal": (torch.float32,),
    "remainder": (torch.float32,),
    "repeat": (torch.float32,),
    "reshape": (torch.float32,),
    "resolve_conj": (torch.float32,),
    "resolve_neg": (torch.float32,),
    "round": (torch.float32,),
    "rsqrt": (torch.float32,),
    "rsub": (torch.float32,),
    "scatter_reduce": (torch.float32,),
    "select": (torch.float32,),
    # "scalar_tensor": core_ops.aten_scalar_tensor,  # no test case in OPS_DB
    "scatter_add": (torch.float32,),
    "sigmoid": (torch.float32,),
    "sign": (torch.float32,),
    "sin": (torch.float32,),
    "sinh": (torch.float32,),
    "slice_scatter": (torch.float32,),
    "slice": (torch.float32,),
    "softmax": (torch.float32,),
    "split_with_sizes": (torch.float32,),
    "split": (torch.float32,),
    "sqrt": (torch.float32,),
    "squeeze_dim": (torch.float32,),
    "squeeze": (torch.float32,),
    "stack": (torch.float32,),
    "sub": (torch.float32,),
    "sum": (torch.float32,),
    # "sym_size": core_ops.aten_sym_size,  # no test case in OPS_DB
    ...
    "triu": (torch.float32,),
    "trunc": (torch.float32,),
    "unflatten": (torch.float32,),
    "unsqueeze": (torch.float32,),
    "var_mean": (torch.float32,),
    "var_mean_dim": (torch.float32,),
    "var_mean_correction": (torch.float32,),
    "view": (torch.float32,),
    "where": (torch.float32,),
    "xlogy": (torch.float32,),
    "zeros": (torch.float32,),
    "zeros_like": (torch.float32,),
}
