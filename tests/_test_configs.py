...
DETECTION_CONFIGS: list[tuple[str, dict, bool]] = [
    ...
    (
        "rt_detr",
        {
            ...
            "num_labels": 4,
            "image_size": 64,
            "backbone_embedding_size": 16,
            "backbone_hidden_sizes": [32, 64, 128, 256],
...
VL_CONFIGS: list[tuple[str, dict, bool]] = [
    ...
    ("videollama3_qwen2", {"vision": _TINY_VISION, "image_token_id": 151665}, False),
    # --- InternVL family ---
