...
Properties of a generated ModelProto can be set by passing in extra named
...
from onnxscript import model
from onnxscript.onnx_opset import opset15 as op
from onnxscript.onnx_types import FLOAT

@model(ir_version=7, producer_name="OnnxScript", producer_version="0.1")
