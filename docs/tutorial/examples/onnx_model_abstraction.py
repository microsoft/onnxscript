...
from onnxscript import OnnxModel
...
OnnxModelObj = OnnxModel(onnx_model)
for node in OnnxModelObj.nodes(): print(node.op_type)
matmul_nodes = OnnxModelObj.get_nodes_by_op_type('MatMul')
print(matmul_nodes)
